...
@class SharedSpellGameUser, SharedMultiUserGame, SharedWord, SharedMultiUserGameCompanion, SharedSpellGameUserCompanion, SharedWordCompanion, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;
