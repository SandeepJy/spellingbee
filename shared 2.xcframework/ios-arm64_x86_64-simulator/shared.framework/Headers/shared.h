...
- (void)deleteAudioGameId:(NSString *)gameId word:(NSString *)word completion:(void (^)(id _Nullable))completion __attribute__((swift_name("deleteAudio(gameId:word:completion:)")));
- (void)dispose __attribute__((swift_name("dispose()")));
- (void)downloadAudioGameId:(NSString *)gameId word:(NSString *)word completion:(void (^)(id _Nullable))completion __attribute__((swift_name("downloadAudio(gameId:word:completion:)")));
...
- (void)loginEmail:(NSString *)email password:(NSString *)password completion:(void (^)(id _Nullable))completion __attribute__((swift_name("login(email:password:completion:)")));
- (void)registerUsername:(NSString *)username email:(NSString *)email password:(NSString *)password completion:(void (^)(id _Nullable))completion __attribute__((swift_name("register(username:email:password:completion:)")));
...
- (void)signOutCompletion:(void (^)(id _Nullable))completion __attribute__((swift_name("signOut(completion:)")));
...
- (void)uploadAudioGameId:(NSString *)gameId word:(NSString *)word audioData:(SharedKotlinByteArray *)audioData completion:(void (^)(id _Nullable))completion __attribute__((swift_name("uploadAudio(gameId:word:audioData:completion:)")));
...
- (instancetype)initWithText:(NSString *)text audioUrl:(NSString * _Nullable)audioUrl recordedBy:(NSString * _Nullable)recordedBy __attribute__((swift_name("init(text:audioUrl:recordedBy:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWordCompanion *companion __attribute__((swift_name("companion")));
- (SharedWord *)doCopyText:(NSString *)text audioUrl:(NSString * _Nullable)audioUrl recordedBy:(NSString * _Nullable)recordedBy __attribute__((swift_name("doCopy(text:audioUrl:recordedBy:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable audioUrl __attribute__((swift_name("audioUrl")));
@property (readonly) NSString * _Nullable recordedBy __attribute__((swift_name("recordedBy")));
