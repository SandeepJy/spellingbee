...
@class SharedWord, SharedKotlinByteArray, SharedMultiUserGame, SharedUserGameProgress, SharedSpellGameUser, SharedAuthManager, SharedStorageManager, SharedMultiUserGameCompanion, SharedSpellGameUserCompanion, SharedUserGameProgressCompanion, SharedWordCompanion, SharedKotlinByteIterator, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
__attribute__((swift_name("IOSGameManager")))
@interface SharedIOSGameManager : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)addUserId:(NSString *)id username:(NSString *)username email:(NSString *)email completion:(void (^)(void))completion __attribute__((swift_name("addUser(id:username:email:completion:)")));
- (void)addWordsGameId:(NSString *)gameId words:(NSArray<SharedWord *> *)words completion:(void (^)(SharedBoolean *))completion __attribute__((swift_name("addWords(gameId:words:completion:)")));
- (void)clearAllErrors __attribute__((swift_name("clearAllErrors()")));
- (void)createGameCreatorId:(NSString *)creatorId participantIds:(NSSet<NSString *> *)participantIds completion:(void (^)(NSString *))completion __attribute__((swift_name("createGame(creatorId:participantIds:completion:)")));
- (void)deleteAudioGameId:(NSString *)gameId word:(NSString *)word completion:(void (^)(SharedBoolean *, NSString * _Nullable))completion __attribute__((swift_name("deleteAudio(gameId:word:completion:)")));
- (void)dispose __attribute__((swift_name("dispose()")));
- (void)downloadAudioGameId:(NSString *)gameId word:(NSString *)word completion:(void (^)(SharedKotlinByteArray * _Nullable, NSString * _Nullable))completion __attribute__((swift_name("downloadAudio(gameId:word:completion:)")));
- (NSString * _Nullable)getCreatorNameGame:(SharedMultiUserGame *)game __attribute__((swift_name("getCreatorName(game:)")));
- (NSArray<NSString *> *)getParticipantNamesGame:(SharedMultiUserGame *)game __attribute__((swift_name("getParticipantNames(game:)")));
- (SharedUserGameProgress * _Nullable)getUserProgressUserId:(NSString *)userId gameId:(NSString *)gameId __attribute__((swift_name("getUserProgress(userId:gameId:)")));
- (void)loadGamesCompletion:(void (^)(void))completion __attribute__((swift_name("loadGames(completion:)")));
- (void)loadUserProgressCompletion:(void (^)(void))completion __attribute__((swift_name("loadUserProgress(completion:)")));
- (void)loadUsersCompletion:(void (^)(void))completion __attribute__((swift_name("loadUsers(completion:)")));
- (void)loginEmail:(NSString *)email password:(NSString *)password completion:(void (^)(SharedSpellGameUser * _Nullable, NSString * _Nullable))completion __attribute__((swift_name("login(email:password:completion:)")));
- (void)registerUsername:(NSString *)username email:(NSString *)email password:(NSString *)password completion:(void (^)(SharedSpellGameUser * _Nullable, NSString * _Nullable))completion __attribute__((swift_name("register(username:email:password:completion:)")));
- (void)setCurrentUserUser:(SharedSpellGameUser *)user completion:(void (^)(void))completion __attribute__((swift_name("setCurrentUser(user:completion:)")));
- (void)signOutCompletion:(void (^)(SharedBoolean *, NSString * _Nullable))completion __attribute__((swift_name("signOut(completion:)")));
- (void)startGameGameId:(NSString *)gameId completion:(void (^)(SharedBoolean *))completion __attribute__((swift_name("startGame(gameId:completion:)")));
- (void)updateUserProgressGameId:(NSString *)gameId userId:(NSString *)userId wordIndex:(int32_t)wordIndex completedWordIndices:(NSArray<SharedInt *> *)completedWordIndices score:(int32_t)score completion:(void (^)(SharedBoolean *))completion __attribute__((swift_name("updateUserProgress(gameId:userId:wordIndex:completedWordIndices:score:completion:)")));
- (void)uploadAudioGameId:(NSString *)gameId word:(NSString *)word audioData:(SharedKotlinByteArray *)audioData completion:(void (^)(NSString * _Nullable, NSString * _Nullable))completion __attribute__((swift_name("uploadAudio(gameId:word:audioData:completion:)")));
@property void (^ _Nullable onAuthErrorChanged)(NSString * _Nullable) __attribute__((swift_name("onAuthErrorChanged")));
@property void (^ _Nullable onAuthLoadingChanged)(SharedBoolean *) __attribute__((swift_name("onAuthLoadingChanged")));
@property void (^ _Nullable onAuthUserChanged)(SharedSpellGameUser * _Nullable) __attribute__((swift_name("onAuthUserChanged")));
@property void (^ _Nullable onCurrentUserChanged)(SharedSpellGameUser * _Nullable) __attribute__((swift_name("onCurrentUserChanged")));
@property void (^ _Nullable onErrorChanged)(NSString * _Nullable) __attribute__((swift_name("onErrorChanged")));
@property void (^ _Nullable onGamesChanged)(NSArray<SharedMultiUserGame *> *) __attribute__((swift_name("onGamesChanged")));
@property void (^ _Nullable onIsLoadingChanged)(SharedBoolean *) __attribute__((swift_name("onIsLoadingChanged")));
@property void (^ _Nullable onStorageErrorChanged)(NSString * _Nullable) __attribute__((swift_name("onStorageErrorChanged")));
@property void (^ _Nullable onStorageLoadingChanged)(SharedBoolean *) __attribute__((swift_name("onStorageLoadingChanged")));
@property void (^ _Nullable onUserProgressChanged)(NSDictionary<NSString *, SharedUserGameProgress *> *) __attribute__((swift_name("onUserProgressChanged")));
@property void (^ _Nullable onUsersChanged)(NSArray<SharedSpellGameUser *> *) __attribute__((swift_name("onUsersChanged")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthManager")))
@interface SharedAuthManager : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)registerUsername:(NSString *)username email:(NSString *)email password:(NSString *)password completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("register(username:email:password:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)signOutWithCompletionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("signOut(completionHandler:)")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> currentUser __attribute__((swift_name("currentUser")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> error __attribute__((swift_name("error")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> isLoading __attribute__((swift_name("isLoading")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GameManager")))
@interface SharedGameManager : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addUserId:(NSString *)id username:(NSString *)username email:(NSString *)email completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("addUser(id:username:email:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addWordsGameId:(NSString *)gameId words:(NSArray<SharedWord *> *)words completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("addWords(gameId:words:completionHandler:)")));
- (void)clearError __attribute__((swift_name("clearError()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createGameCreatorId:(NSString *)creatorId participantIds:(NSSet<NSString *> *)participantIds completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("createGame(creatorId:participantIds:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteAudioGameId:(NSString *)gameId word:(NSString *)word completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("deleteAudio(gameId:word:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)downloadAudioGameId:(NSString *)gameId word:(NSString *)word completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("downloadAudio(gameId:word:completionHandler:)")));
- (NSString * _Nullable)getCreatorNameGame:(SharedMultiUserGame *)game __attribute__((swift_name("getCreatorName(game:)")));
- (NSArray<NSString *> *)getParticipantNamesGame:(SharedMultiUserGame *)game __attribute__((swift_name("getParticipantNames(game:)")));
- (SharedSpellGameUser * _Nullable)getUserId:(NSString *)id __attribute__((swift_name("getUser(id:)")));
- (SharedUserGameProgress * _Nullable)getUserProgressUserId:(NSString *)userId gameId:(NSString *)gameId __attribute__((swift_name("getUserProgress(userId:gameId:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loadGamesWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("loadGames(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loadUserProgressWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("loadUserProgress(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loadUsersWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("loadUsers(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setCurrentUserUser:(SharedSpellGameUser *)user completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("setCurrentUser(user:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)startGameGameId:(NSString *)gameId completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("startGame(gameId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateUserProgressGameId:(NSString *)gameId userId:(NSString *)userId wordIndex:(int32_t)wordIndex completedWordIndices:(NSArray<SharedInt *> *)completedWordIndices score:(int32_t)score completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updateUserProgress(gameId:userId:wordIndex:completedWordIndices:score:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadAudioGameId:(NSString *)gameId word:(NSString *)word audioData:(SharedKotlinByteArray *)audioData completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("uploadAudio(gameId:word:audioData:completionHandler:)")));
@property (readonly) SharedAuthManager *authManager __attribute__((swift_name("authManager")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> currentUser __attribute__((swift_name("currentUser")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> error __attribute__((swift_name("error")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> games __attribute__((swift_name("games")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> isLoading __attribute__((swift_name("isLoading")));
@property (readonly) SharedStorageManager *storageManager __attribute__((swift_name("storageManager")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> userProgress __attribute__((swift_name("userProgress")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> users __attribute__((swift_name("users")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StorageManager")))
@interface SharedStorageManager : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)clearError __attribute__((swift_name("clearError()")));
...
- (void)uploadAudioGameId:(NSString *)gameId word:(NSString *)word audioData:(SharedKotlinByteArray *)audioData completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("uploadAudio(gameId:word:audioData:completionHandler:)")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> error __attribute__((swift_name("error")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> isDownloading __attribute__((swift_name("isDownloading")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> isUploading __attribute__((swift_name("isUploading")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MultiUserGame")))
@interface SharedMultiUserGame : SharedBase
- (instancetype)initWithId:(NSString *)id creatorId:(NSString *)creatorId participantIds:(NSSet<NSString *> *)participantIds words:(NSArray<SharedWord *> *)words creationDate:(int64_t)creationDate isStarted:(BOOL)isStarted __attribute__((swift_name("init(id:creatorId:participantIds:words:creationDate:isStarted:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMultiUserGameCompanion *companion __attribute__((swift_name("companion")));
- (SharedMultiUserGame *)doCopyId:(NSString *)id creatorId:(NSString *)creatorId participantIds:(NSSet<NSString *> *)participantIds words:(NSArray<SharedWord *> *)words creationDate:(int64_t)creationDate isStarted:(BOOL)isStarted __attribute__((swift_name("doCopy(id:creatorId:participantIds:words:creationDate:isStarted:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int64_t creationDate __attribute__((swift_name("creationDate")));
@property (readonly) NSString *creatorId __attribute__((swift_name("creatorId")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) BOOL isStarted __attribute__((swift_name("isStarted")));
@property (readonly) NSSet<NSString *> *participantIds __attribute__((swift_name("participantIds")));
@property (readonly) NSArray<SharedWord *> *words __attribute__((swift_name("words")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MultiUserGame.Companion")))
@interface SharedMultiUserGameCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMultiUserGameCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SpellGameUser")))
@interface SharedSpellGameUser : SharedBase
- (instancetype)initWithId:(NSString *)id username:(NSString *)username email:(NSString *)email __attribute__((swift_name("init(id:username:email:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSpellGameUserCompanion *companion __attribute__((swift_name("companion")));
- (SharedSpellGameUser *)doCopyId:(NSString *)id username:(NSString *)username email:(NSString *)email __attribute__((swift_name("doCopy(id:username:email:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SpellGameUser.Companion")))
@interface SharedSpellGameUserCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSpellGameUserCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserGameProgress")))
@interface SharedUserGameProgress : SharedBase
- (instancetype)initWithId:(NSString *)id userId:(NSString *)userId gameId:(NSString *)gameId completedWordIndices:(NSArray<SharedInt *> *)completedWordIndices currentWordIndex:(int32_t)currentWordIndex score:(int32_t)score lastUpdated:(int64_t)lastUpdated __attribute__((swift_name("init(id:userId:gameId:completedWordIndices:currentWordIndex:score:lastUpdated:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedUserGameProgressCompanion *companion __attribute__((swift_name("companion")));
- (SharedUserGameProgress *)doCopyId:(NSString *)id userId:(NSString *)userId gameId:(NSString *)gameId completedWordIndices:(NSArray<SharedInt *> *)completedWordIndices currentWordIndex:(int32_t)currentWordIndex score:(int32_t)score lastUpdated:(int64_t)lastUpdated __attribute__((swift_name("doCopy(id:userId:gameId:completedWordIndices:currentWordIndex:score:lastUpdated:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedInt *> *completedWordIndices __attribute__((swift_name("completedWordIndices")));
@property (readonly) int32_t currentWordIndex __attribute__((swift_name("currentWordIndex")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserGameProgress.Companion")))
@interface SharedUserGameProgressCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedUserGameProgressCompanion *shared __attribute__((swift_name("shared")));
- (NSString *)generateIdUserId:(NSString *)userId gameId:(NSString *)gameId __attribute__((swift_name("generateId(userId:gameId:)")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithId:(NSString *)id word:(NSString *)word soundUrl:(NSString * _Nullable)soundUrl level:(int32_t)level createdByID:(NSString *)createdByID gameID:(NSString * _Nullable)gameID __attribute__((swift_name("init(id:word:soundUrl:level:createdByID:gameID:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWordCompanion *companion __attribute__((swift_name("companion")));
- (SharedWord *)doCopyId:(NSString *)id word:(NSString *)word soundUrl:(NSString * _Nullable)soundUrl level:(int32_t)level createdByID:(NSString *)createdByID gameID:(NSString * _Nullable)gameID __attribute__((swift_name("doCopy(id:word:soundUrl:level:createdByID:gameID:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString *createdByID __attribute__((swift_name("createdByID")));
...
@property (readonly) NSString * _Nullable soundUrl __attribute__((swift_name("soundUrl")));
@property (readonly) NSString *word __attribute__((swift_name("word")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Word.Companion")))
@interface SharedWordCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWordCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
